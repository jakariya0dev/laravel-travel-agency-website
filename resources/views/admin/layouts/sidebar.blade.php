<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/destinations/') ? 'active' : '' }}"><a class="nav-link" href="{{ route('destinations.index') }}"><i class="fas fa-hand-point-right"></i> <span>Destinations</span></a></li>
            <li class="{{ Request::is('admin/package/') ? 'active' : '' }}"><a class="nav-link" href="{{ route('package.index') }}"><i class="fas fa-hand-point-right"></i> <span>Package</span></a></li>
